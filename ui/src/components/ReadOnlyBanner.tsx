...
export function ReadOnlyBanner() {
  ...
  return (
    <div className="mb-5 flex items-start gap-2.5 rounded-lg border border-slate-800 bg-slate-900/60 px-4 py-2.5 text-xs text-slate-400">
      <svg viewBox="0 0 20 20" fill="currentColor" className="mt-0.5 h-4 w-4 shrink-0 text-slate-500" aria-hidden>
      ...
      <span>
        <strong className="text-slate-300">Read-only access.</strong> You can view everything, but
